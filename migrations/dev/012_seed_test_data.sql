...
INSERT INTO business_settings (business_name, business_type, timezone, currency, tax_rate, phone, email, website, address_line1, city, state, postal_code, country)
...
-- Organizations
INSERT INTO organizations (uuid, name, org_type, website, created_by) VALUES
(UUID(), 'Dallas Dental Group', 'company', 'https://dallasdental.example.com', 'system'),
(UUID(), 'Smith Household', 'household', NULL, 'system');

-- Tags
INSERT INTO tags (code, label, sort_order) VALUES
('vip', 'VIP Customer', 1),
('repeat', 'Repeat Customer', 2),
('referral_source', 'Referral Source', 3);

-- Contacts (5 total: 2 clients, 1 prospect, 1 lead, 1 vendor)
INSERT INTO contacts (uuid, contact_type_id, organization_id, first_name, last_name, display_name, enrichment_status, external_refs_json, created_by)
VALUES (UUID(), 1, NULL, 'Sarah', 'Johnson', NULL, 'complete', '{"invoiceninja": "INV-C-001", "chatwoot": "CW-1001"}', 'system');

INSERT INTO contacts (uuid, contact_type_id, organization_id, first_name, last_name, enrichment_status, created_by)
VALUES (UUID(), 2, 1, 'Dr. Michael', 'Chen', 'partial', 'system');

INSERT INTO contacts (uuid, contact_type_id, first_name, last_name, enrichment_status, created_by)
VALUES (UUID(), 3, 'Emily', 'Rodriguez', 'needs_review', 'website_form');

INSERT INTO contacts (uuid, contact_type_id, first_name, last_name, converted_at, converted_from_type_id, enrichment_status, created_by)
VALUES (UUID(), 1, 'James', 'Smith', '2026-03-15 10:30:00', 2, 'complete', 'system');

INSERT INTO contacts (uuid, contact_type_id, first_name, last_name, enrichment_status, notes_text, created_by)
...
INSERT INTO contact_phones (contact_id, phone_type_id, phone_number, is_primary, is_verified, verified_at, data_source) VALUES
...
-- Email addresses
INSERT INTO contact_emails (contact_id, email_type_id, email_address, is_primary, is_verified, verified_at, data_source) VALUES
...
-- Physical addresses
INSERT INTO contact_addresses (contact_id, address_type_id, address_line1, city, state, postal_code, country, is_primary, data_source) VALUES
...
INSERT INTO org_phones (organization_id, phone_type_id, phone_number, is_primary, data_source) VALUES (1, 3, '+15555550500', TRUE, 'manual');
INSERT INTO org_emails (organization_id, email_type_id, email_address, is_primary, data_source) VALUES (1, 2, 'office@dallasdental.example.com', TRUE, 'manual');
INSERT INTO org_addresses (organization_id, address_type_id, address_line1, city, state, postal_code, country, is_primary, data_source) VALUES (1, 2, '100 Medical Plaza Dr', 'Dallas', 'TX', '75230', 'US', TRUE, 'manual');

-- Channel preferences
INSERT INTO contact_channel_prefs (contact_id, channel_type_id, is_preferred, opt_in_status, opted_in_at) VALUES
...
INSERT INTO contact_marketing_sources (contact_id, marketing_source_id, source_detail, attributed_at) VALUES
...
-- Tags (M:M junction)
INSERT INTO contact_tag_map (contact_id, tag_id) VALUES (1, 1), (1, 2), (4, 2), (4, 3);

-- Orders
INSERT INTO orders (uuid, contact_id, order_status_id, order_number, order_date, due_date, subtotal, discount_amount, tax_amount, total, created_by)
VALUES (UUID(), 1, 4, 'ORD-2026-001', '2026-01-20', '2026-02-03', 150.00, 0.00, 12.38, 162.38, 'system');
INSERT INTO orders (uuid, contact_id, order_status_id, order_number, order_date, due_date, subtotal, discount_amount, tax_amount, total, notes_text, created_by)
...
INSERT INTO orders (uuid, contact_id, order_status_id, order_number, order_date, subtotal, tax_amount, total, notes_text, created_by)
VALUES (UUID(), 2, 1, 'ORD-2026-003', '2026-04-01', 1200.00, 99.00, 1299.00, 'Bulk order: 50 lab coats with practice logo', 'system');
INSERT INTO orders (uuid, contact_id, order_status_id, order_number, order_date, due_date, scheduled_at, subtotal, tax_amount, total, created_by)
VALUES (UUID(), 4, 4, 'ORD-2026-004', '2026-03-15', '2026-03-20', '2026-03-18 14:00:00', 85.00, 7.01, 92.01, 'system');

-- Order items
INSERT INTO order_items (order_id, item_type_id, description, quantity, unit_price, discount_amount, line_total, sort_order) VALUES
...
INSERT INTO order_status_history (order_id, from_status_id, to_status_id, changed_by, created_at) VALUES
...
-- Invoices
INSERT INTO invoices (uuid, order_id, invoice_status_id, invoice_number, invoice_date, due_date, subtotal, tax_amount, total, amount_paid, balance_due, external_invoice_id)
VALUES (UUID(), 1, 3, 'INV-2026-001', '2026-01-20', '2026-02-03', 150.00, 12.38, 162.38, 162.38, 0.00, 'NINJA-INV-10001');
INSERT INTO invoices (uuid, order_id, invoice_status_id, invoice_number, invoice_date, due_date, subtotal, tax_amount, total, amount_paid, balance_due)
...
-- Payments
INSERT INTO payments (uuid, invoice_id, payment_method_id, amount, payment_date, reference_number, external_payment_id) VALUES
...
-- Communications
INSERT INTO communications (uuid, contact_id, channel_type_id, order_id, direction, subject, body, occurred_at, external_message_id, created_by) VALUES
