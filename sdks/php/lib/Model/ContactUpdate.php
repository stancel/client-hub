...
class ContactUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    {
        return $this->container['enrichment_status'];
    }

    /**
     * Sets enrichment_status
     *
     * @param string|null $enrichment_status enrichment_status
     *
     * @return self
     */
    public function setEnrichmentStatus($enrichment_status)
    {
        if (is_null($enrichment_status)) {
            array_push($this->openAPINullablesSetToNull, 'enrichment_status');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('enrichment_status', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['enrichment_status'] = $enrichment_status;
