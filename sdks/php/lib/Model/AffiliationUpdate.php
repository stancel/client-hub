...
/**
 * AffiliationUpdate Class Doc Comment
 *
 * @category Class
 * @package  ClientHub
 * @author   OpenAPI Generator team
 ...
 */
class AffiliationUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AffiliationUpdate';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('is_decision_maker', $data ?? [], null);
    ...
    */
    ...
    public function setIsDecisionMaker($is_decision_maker)
    {
        if (is_null($is_decision_maker)) {
            array_push($this->openAPINullablesSetToNull, 'is_decision_maker');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('is_decision_maker', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
