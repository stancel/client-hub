...
/**
 * LookupMatchChannelPref Class Doc Comment
 *
 * @category Class
 * @package  ClientHub
 * @author   OpenAPI Generator team
 ...
 */
class LookupMatchChannelPref implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LookupMatchChannelPref';
    ...
    */
    ...
    {
        if (is_null($opt_in)) {
            array_push($this->openAPINullablesSetToNull, 'opt_in');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('opt_in', $nullablesSetToNull);
            if ($index !== FALSE) {
