...
class OrderCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets items
     *
     * @return \ClientHub\Model\OrderItemCreate[]|null
     */
     ...
     * Sets items
     *
     * @param \ClientHub\Model\OrderItemCreate[]|null $items items
     *
     * @return self
     */
     ...
     * Sets notes_text
     *
     * @param string|null $notes_text notes_text
     *
     * @return self
     */
    public function setNotesText($notes_text)
    {
        if (is_null($notes_text)) {
            array_push($this->openAPINullablesSetToNull, 'notes_text');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('notes_text', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
