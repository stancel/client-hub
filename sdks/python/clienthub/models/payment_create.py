...
class PaymentCreate(BaseModel):
    ...
    payment_method: Optional[StrictStr] = 'online'
    reference_number: Optional[StrictStr] = None
    external_payment_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["amount", "payment_date", "payment_method", "reference_number", "external_payment_id"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if external_payment_id (nullable) is None
        # and model_fields_set contains the field
        if self.external_payment_id is None and "external_payment_id" in self.model_fields_set:
            _dict['external_payment_id'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payment_method": obj.get("payment_method") if obj.get("payment_method") is not None else 'online',
