...
class AffiliationCreate(BaseModel):
    ...
    is_decision_maker: Optional[StrictBool] = False
    is_primary: Optional[StrictBool] = False
    start_date: Optional[date] = None
    end_date: Optional[date] = None
    notes: Optional[StrictStr] = None
    external_refs_json: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["organization_uuid", "role_title", "department", "seniority", "is_decision_maker", "is_primary", "start_date", "end_date", "notes", "external_refs_json"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "is_decision_maker": obj.get("is_decision_maker") if obj.get("is_decision_maker") is not None else False,
